...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: "/dashboard/ai-research/projects", destination: "/dashboard/ai-research", permanent: false },
      { source: "/demo/ai/dashboard/research/projects", destination: "/dashboard/ai-research", permanent: false },
