...
export const HomeDepartmentTemplates = forwardRef<HTMLElement>(function HomeDepartmentTemplates(_, ref) {
  return (
    <section ref={ref} id="departments" className="section relative bg-[#0a0a0f] z-10">
      <div className="departments-content container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-sm text-gray-500 uppercase tracking-wider mb-4">Department Solutions</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Empower Every Department</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            From HR to Engineering, Marketing to Legal — Quantiva provides tailored templates and AI tools for every
          ...
          {departments.map((dept, index) => (
            <div key={index} className="card group hover:border-[#5b4cdb]/30 transition-all">
              <div className="flex items-start justify-between mb-4">
                ...
                <span className="text-xs px-2 py-1 bg-white/5 text-gray-400 rounded-full">{dept.docCount}</span>
              </div>
              ...
              <div className="space-y-1 mb-4">
                ...
                {dept.templates.length > 3 && (
                  <p className="text-xs text-gray-600 pl-5">+{dept.templates.length - 3} more</p>
                )}
              </div>
        ...
        <div className="card">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Unify Your Organization</h3>
              <p className="text-gray-400 mb-6">
                Give every department the tools they need to create professional, on-brand documents — all from one
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="mailto:info@quantiva.world?subject=Enterprise%20inquiry" className="btn btn-primary">
                  Contact Sales
                </a>
                <Link href="/pricing" className="btn btn-secondary text-center">
                  View Pricing
                </Link>
              </div>
            </div>
            ...
            <div className="card bg-white/5 text-center">
              ...
              <h4 className="text-xl font-bold text-white mb-2">Enterprise Plans Available</h4>
              <p className="text-gray-400 mb-6">
                Get unlimited access for your entire organization with SSO, advanced security, and dedicated support.
              </p>
            </div>
          </div>
        </div>
