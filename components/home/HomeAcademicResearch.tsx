...
export const HomeAcademicResearch = forwardRef<HTMLElement>(function HomeAcademicResearch(_, ref) {
  return (
    <section ref={ref} id="academic-research" className="section relative bg-[#0a0a0f] z-10">
      <div className="academic-content container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-sm text-gray-500 uppercase tracking-wider mb-4">Academic Research AI</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Supercharge Your Research</h2>
            <p className="text-gray-400 mb-8">
              From literature reviews to thesis writing — Quantiva&apos;s Academic Research AI helps students,
              researchers, and academics produce high-quality work faster.
            </p>
        ...
        <div className="mt-16 card">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Why Researchers Choose Quantiva</h3>
              <p className="text-gray-400 mb-6">
                Join thousands of students, PhD candidates, and research professionals who trust Quantiva for their
                academic documentation needs.
              </p>
            ...
            <div className="card bg-white/5">
              ...
              <p className="text-gray-300 mb-6 italic">
                &quot;Quantiva&apos;s Academic Research AI helped me complete my literature review in days instead of
                weeks. The citation management alone saved me countless hours.&quot;
              </p>
