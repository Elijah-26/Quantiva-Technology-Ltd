...
const steps = [
  {
    ...
    description:
      'Select from 50+ pre-built templates or create custom documents. Our AI understands FCA, PRA, GDPR, and other major frameworks.',
  },
  {
    number: '02',
    icon: FileEdit,
  ...
  },
  {
    ...
    description:
      'Built-in guardrails check your document against current regulations and highlight any potential issues.',
  },
  {
    number: '04',
    icon: Download,
...
export const HomeHowItWorks = forwardRef<HTMLElement>(function HomeHowItWorks(_, ref) {
  return (
    <section ref={ref} id="how-it-works" className="section relative bg-[#0a0a0f] z-10">
      <div className="howitworks-content container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-sm text-gray-500 uppercase tracking-wider mb-4">How It Works</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">From Template to Compliance in 4 Steps</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {steps.map((step, index) => (
            <div key={index} className="step-item relative">
              <span className="text-6xl font-bold text-white/5 absolute -top-4 -left-2">{step.number}</span>
          ...
          {[
            ...
            <div key={index} className="card text-center hover:border-[#5b4cdb]/30 transition-all">
              <p className="text-4xl font-bold text-white mb-1">
                {stat.value}
                <span className="text-2xl text-[#5b4cdb]">{stat.unit}</span>
              </p>
