...
export function BusinessSolutions() {
  ...
  return (
    <section id="business-solutions" className="section relative bg-[#0a0a0f]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            From startup pitch decks to enterprise compliance — Quantiva provides 
            the documents you need to grow, scale, and succeed.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-16">
          {solutions.map((solution, index) => (
            <div key={index} className="card group hover:border-[#5b4cdb]/30 transition-all">
              ...
              <a
                href={`/business/${solution.title.toLowerCase()}`}
